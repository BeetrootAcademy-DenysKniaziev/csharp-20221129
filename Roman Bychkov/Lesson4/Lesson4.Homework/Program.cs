class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Enter the value of x1, x2, x3, x4");
    ...
    #region MaxBetween
    static int MaxBetween(int x1, int x2) => Math.Max(x1, x2);
    static int MaxBetween(int x1, int x2, int x3) => MaxBetween(Math.Max(x1, x2), x3);
    static int MaxBetween(int x1, int x2, int x3, int x4) => MaxBetween(Math.Max(x1, x2), x3, x4);
    #endregion

    #region MinBetween
    static int MinBetween(int x1, int x2) => Math.Min(x1, x2);
    static int MinBetween(int x1, int x2, int x3) => MinBetween(Math.Min(x1, x2), x3);
    static int MinBetween(int x1, int x2, int x3, int x4) => MinBetween(Math.Min(x1, x2), x3, x4);
