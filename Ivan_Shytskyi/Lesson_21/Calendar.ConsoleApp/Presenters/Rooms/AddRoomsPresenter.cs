...
{
    internal class AddRoomsPresenter : IPresenter
    {
        private readonly IService<Meeting> _serviceMeeting;
        private readonly IService<Room> _serviceRoom;
        private readonly int _check;
        public AddRoomsPresenter(IService<Meeting> serviceMeeting, IService<Room> serviceRoom, int check)
        {
        ...
        public IPresenter Action()
        {
            ...
            _serviceRoom.Add(new Room(name));
