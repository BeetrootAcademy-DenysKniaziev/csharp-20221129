...
namespace Homework29.AddHightToActorMigartion
{
    ...
    [Migration("20230219052810_AddHightToActor")]
    partial class AddHightToActor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homework29.DTO.AwardingCompetitiors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasIndex("AwardingId");

                    b.ToTable("awarding_competitiors","public");
                });
            ...
            modelBuilder.Entity("Homework29.DTO.AwardingCompetitiors", b =>
                {
                    ...
                    b.HasOne("Homework29.DTO.Awarding", "Awarding")
                        .WithMany()
                        .HasForeignKey("AwardingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
