...
Random x = new Random(); //обращение к классу случайных величин
int X = x.Next(1, 10);
WriteLine("if X=" + X + " Y=" + (-6 * X * X * X + 5 * X * X - 10 * X + 15));
...
WriteLine((DaysInThisYear - DT.DayOfYear + 1 - ProcentsOfCurrentDay) + (DT.DayOfYear - 1 + ProcentsOfCurrentDay) + " days in thie year");
