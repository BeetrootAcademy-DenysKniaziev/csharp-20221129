namespace Lesson24.Homework
{
    public static class MathUtils
    {
        ...
        public static string Analyze(string str3)
        {
            var IsSymbol = 0;
            var IsLetter = 0;
            var IsDigit = 0;
            ...
            string res = $"Letters: {IsLetter}\nDigits: {IsDigit}\nSymbols: {IsSymbol}";
            return res;
        }

        public static string Sort(string str4)
        {
        ...
        public static string Duplicate(string str4)
        {
            string res = "";
